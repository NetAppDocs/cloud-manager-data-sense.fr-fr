...
* Pour installer Cloud Data dans le cloud, il faut déployer une instance cloud, ce qui entraîne des frais supplémentaires du fournisseur cloud chargé du déploiement. Voir  Cloud Data Sense instance,type d'instance déployé pour chaque fournisseur cloud. L'installation de Data Sense sur un système sur site est gratuite.
...
| Très grand (par défaut) | 16 PROCESSEURS, 64 GO DE RAM, 500 GO DE SSD | Aucune 
